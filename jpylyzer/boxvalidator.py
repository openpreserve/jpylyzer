...
from . import shared
from .csboxvalidator import CSBoxValidator
...
class BoxValidator:
    ...
    def validate(self):
        ...
        try:
            if self.boxType == "contiguousCodestreamBox":
                to_call = getattr(CSBoxValidator(self.options, self.boxType, self.boxContents), "validate_" + self.boxType)
            else:
